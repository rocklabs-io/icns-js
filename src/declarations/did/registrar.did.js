export const idlRegistrarFactory = ({ IDL }) => {
  ...
  const ICNSRegistrar = IDL.Service({
    ...
    'exportAuctions' : IDL.Func([], [IDL.Vec(AuctionExt)], ['query']),
    ...
    'exportBids' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Principal, IDL.Vec(BidExt)))],
        ['query'],
      ),
    'exportExpiries' : IDL.Func(
        [],
        [IDL.Vec(IDL.Tuple(IDL.Text, IDL.Int))],
        ['query'],
      ),
    'forceClaim' : IDL.Func([], [IDL.Nat], []),
    ...
    'getRecentlyRegisterName' : IDL.Func(
      [],
      [IDL.Vec(RegisterInfo)],
      ['query'],
    ),
    ...
    'instantRegister' : IDL.Func([IDL.Text], [TxReceipt], []),
